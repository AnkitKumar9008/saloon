    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-light navbar-light">
            <a href="index.php" class="navbar-brand mx-4 mb-3">
                <h3 class="text-primary">Super Admin</h3>
            </a>
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="admin.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Branch</a>
                <a href="appointment.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Appointment</a>
                <a href="bill.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Bills</a>
